...
\f1\b0 \cf0 This README is for an image processing program created by Tehani Cabour and updated by Henry deGrasse and Wanru Shao for Northeastern University\'92s Object Oriented Design class. The image processing program works by loading in any image and altering the image and saving it as a new altered image.\
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0
...
\cf0 Mosaic an image implementation: Y\
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0
\cf0 Script command to mosaic an image: Y\
\pard\pardeftab720\partightenfactor0
\cf0 Mosaic an image from GUI: Y\
\
\pard\pardeftab720\partightenfactor0
...
\f1\b0 \cf0 In this assignment, the main goal we need to achieve is to add a mosaic function to the image processor to give the image a "stained glass window" effect. According to the requirements of Assignment 7, we need to add three new features to the code we received:\
...
\f1\b0 So we needed to make changes in the model, controller, and view parts of the code. Among them, the model part needed the most changes due to the addition of the most important new feature
\f2 :
\f1 mosaic.\
\
...
\f1\b0 \cf0 \
Based on our code provider, the intensity function of the histogram seems to work it's just really slow. They have a pretty old computer. An easy way I used to test if the image file is too big for it was by going into the ImageImpl class in the model and putting System.out.print in the getHistogram method intensity switch case, and if doesn't print that means intensity hasn't finished running.\'a0But all the functions work, just a quick note here.\
\
\pard\tx720\tx1440\tx2160\tx2880\tx3600\tx4320\tx5040\tx5760\tx6480\tx7200\tx7920\tx8640\pardirnatural\partightenfactor0

\f0\b \cf0 Citation for Images
\f1\b0 \
